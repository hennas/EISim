...
do 
    ...
    mvn -q exec:java -Dexec.mainClass="com.github.hennas.eisim.Main" -Dexec.args="-i EISim_settings/settings_C_100servers/ -o EISim_output/C_100results/output_C_100servers_training/ -m EISim_output/C_100results/models_C_100servers/ -T -a  -c  -R $rSteps -s $seed"
    if [ $seed -eq 104 ]; then
