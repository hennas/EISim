...
do 
    ...
    mvn -q exec:java -Dexec.mainClass="com.github.hennas.eisim.Main" -Dexec.args="-i EISim_settings/settings_H_20servers/ -o EISim_output/H_20results/output_H_20servers_training/ -m EISim_output/H_20results/models_H_20servers/ -T -a  -c  -R $rSteps -s $seed"
    if [ $seed -eq 104 ]; then
