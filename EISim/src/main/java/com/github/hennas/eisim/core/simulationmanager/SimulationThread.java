 ...
 * 
 * @see #startSimulation()
 * @see com.github.hennas.eisim.core.simulationmanager.Simulation#launchParallelSimulations()
...
public class SimulationThread {
	 ...
	 * 
	 * @see Simulation#setCustomComputingNode(Class)
	 * @see Simulation#setCustomComputingNodesGenerator(Class)
	 * @see Simulation#setCustomEdgeOrchestrator(Class)
	 * @see Simulation#setCustomMobilityModel(Class)
	 * @see Simulation#setCustomNetworkModel(Class)
	 * @see Simulation#setCustomTaskGenerator(Class)
	 * @see Simulation#setCustomTopologyCreator(Class)
	 * 
