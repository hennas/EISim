 ...
 **/
package com.github.hennas.eisim.core.simulationengine;
 ...
 * {@link com.github.hennas.eisim.core.simulationmanager.SimulationThread
 * SimulationThread} in the
 * {@link com.github.hennas.eisim.core.simulationmanager.SimulationThread#startSimulation()
 * startSimulation()} method. But it is not started until the
 * {@link com.github.hennas.eisim.core.simulationmanager.DefaultSimulationManager#startSimulation()
 * startSimulation()} method of the
 * {@link com.github.hennas.eisim.core.simulationmanager.DefaultSimulationManager
 ...
 * @see com.github.hennas.eisim.core.simulationmanager.DefaultSimulationManager#startSimulation()
...
public class PureEdgeSim {
	...
	protected void processEvent(final Event event) {
		if (event.getTime() < time) {
			// If past event is detected, the times are compared again with 16 decimal precision.
			// This is to avoid false detections due to numerical inaccuracy
			BigDecimal eTime = new BigDecimal(event.getTime()).setScale(16, RoundingMode.DOWN);
			BigDecimal cTime = new BigDecimal(time).setScale(16, RoundingMode.DOWN);
			
			if (eTime.compareTo(cTime) == -1) {
