...
public abstract class AbstractNode extends SimEntity implements ComputingNode {
	 ...
	 * 
	 * @see com.github.hennas.eisim.core.datacentersmanager.DefaultTopologyCreator#getDataCenterByName(String
	 *      name)
	 */
	 ...
	 * 
	 * @see com.github.hennas.eisim.core.datacentersmanager.DefaultComputingNodesGenerator#generateEdgeDevices()
	 */
